  ...
  class DB
    class << self
      ...
      def create
        ...
        @@db.run "CREATE TABLE companies (id CHAR(32) PRIMARY KEY, slug varchar(255) UNIQUE NOT NULL, name varchar(255) UNIQUE NOT NULL, profile text, corpwatch_id CHAR(32), sunlight_id CHAR(32) NOT NULL)"
